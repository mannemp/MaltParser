...
public class ReadChartItem extends ChartItem {
	...
	private String devInputFileName;
	...
	public void initialize(FlowChartInstance flowChartinstance, ChartItemSpecification chartItemSpecification) throws MaltChainedException {
		...
		/*if(reader instanceof TabReader)
			((TabReader) reader).devFileName = OptionManager.instance().getOptionValue(getOptionContainerIndex(), optiongroupName, "devfile").toString();*/
	}
