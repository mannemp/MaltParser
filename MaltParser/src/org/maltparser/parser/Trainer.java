...
public abstract class Trainer extends Algorithm {
	...
	public abstract DependencyStructure pasParse(DependencyStructure goldDependencyGraph, DependencyStructure parseDependencyGraph) throws MaltChainedException;
	/**
