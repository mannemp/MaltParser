 ...
 *
 */
public class CopyOfNivreConfig extends ParserConfiguration {
	...
	public CopyOfNivreConfig(SymbolTableHandler symbolTableHandler, boolean allowRoot, boolean allowReduce) throws MaltChainedException {
		super();
	...
	public void initialize(ParserConfiguration parserConfiguration) throws MaltChainedException {
		if (parserConfiguration != null) {
			final CopyOfNivreConfig nivreConfig = (CopyOfNivreConfig)parserConfiguration;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CopyOfNivreConfig that = (CopyOfNivreConfig)obj;
