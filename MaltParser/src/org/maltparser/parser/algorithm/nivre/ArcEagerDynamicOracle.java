 ...
 *
 */
public class ArcEagerDynamicOracle extends Oracle {

	public ArcEagerDynamicOracle(DependencyParserConfig manager, GuideUserHistory history) throws MaltChainedException {
	...
	//TODO
	public GuideUserAction predict(DependencyStructure gold, ParserConfiguration config, int[] prunedActions) throws MaltChainedException {
		final NivreConfig nivreConfig = (NivreConfig)config;
		final DependencyNode stackPeek = nivreConfig.getStack().peek();
		final int stackPeekIndex = stackPeek.getIndex();
		final int inputPeekIndex = nivreConfig.getInput().peek().getIndex();
