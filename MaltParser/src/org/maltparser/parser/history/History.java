...
//	}
	...
	{
		return actionPool.getPoolList();
	}
	
	public ArrayList<Integer> getActionsCodeList() throws MaltChainedException
	{
		ArrayList<Integer> ret = new ArrayList<Integer>();
		for(ComplexDecisionAction act : actionPool.getPoolList())
			ret.add(new Integer(act.getSingleDecision(0).getDecisionCode()));
		ret.trimToSize();
		return ret;
	}
	...
	public ArrayList<Candidate> getActionsList() throws MaltChainedException
	{
		...
		for(ComplexDecisionAction act : actionPool.getPoolList())
			ret.add(new Candidate(act.getSingleDecision(0).getDecisionCode()));  
		ret.trimToSize();
		return ret;
	}
	...
	{
		ArrayList<ScoredCandidate> ret = new ArrayList<ScoredCandidate>();
        
		for(ComplexDecisionAction act : actionPool.getPoolList())
			ret.add(act.getSingleDecision(0).getKBestList().getCandidate(0) == null ?                                                                                                                      
	                new ScoredCandidate(act.getSingleDecision(0).getDecisionCode())                                                                                                                        
	                    : act.getSingleDecision(0).getKBestList().getCandidate(0));  
		ret.trimToSize();
		return ret;
	}
